...
## Do public schools get better access to public internet?

This research analyses whether public schools in Panama, get access to public internet via access points
...
Construction Polygons (Satellite Data):
Use Moran's I to evaluate the spatial clustering of construction activities over time. Is construction clustering around migrant routes or reception centers? You could calculate Moran’s I for different years to observe changes in spatial autocorrelation patterns.
...
```{r cleaning-coordinates-schools}
#Cleaning data
...
```{r intersection-district-highway}
