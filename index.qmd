...
Below I show 2 plots, where on the left we see the relationship between Access points
...
stargazer(model,
          type = "html",
          title = "Regression Results: Access Points and Population",
          dep.var.labels = "Access Points",
          covariate.labels = c("Intercept", "Population"),
          digits = 4,
          header = FALSE,
