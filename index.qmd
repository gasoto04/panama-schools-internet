...
```{r import-packages, eval=FALSE, echo=FALSE}
#library
...
```{r data-import, eval=FALSE, echo=FALSE}
...
```{r cleaning-coordinates-schools,eval=FALSE, echo=FALSE}
#Cleaning data
...
```{r removing-objects,eval=FALSE, echo=FALSE}
rm(schools_csv, district_path, ap_csv, schools_df)
```

```{r exploratoy-data-analysis, eval=FALSE, echo=FALSE}
...
```{r summary-plots, eval=FALSE, echo=FALSE}
...
```{r access-point-regression, eval=FALSE, echo=FALSE}
